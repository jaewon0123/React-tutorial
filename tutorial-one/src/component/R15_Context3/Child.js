...
const Child = () => {
    ...
    const 사용자추가하기 = () => {
        ...
        //기존에 있는내용을 복제하고 복제한 리스트에 새로운 유저를 추가해서 덮어쓰기
    ...
    return (
        <div>
            ...
            <input type="text" id="inputId" onChange={(e) => {setInputName(e.target.value)}} value={inputName}/><br></br>
            ...
            {/* onChange={(e) => {setInputName(e.target.value)}} 
                ...
                e(움직임이 발생).target(움직임이발생한 목표).value(값이 무엇인지 가져옴)
                value={inputName}
                  값 ={초기값(=useState(''))}
