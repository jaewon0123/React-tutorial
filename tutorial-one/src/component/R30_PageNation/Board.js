...
const Board = () => {
    ...
    const lastItem = currentPage * itemPerPage; // 변수명변경 마지막항목 -> lastItem
    const firstItem = lastItem - itemPerPage; // 변수명변경 첫번째항목 -> firstItem
    const 게시글리스트 = data.slice(firstItem, lastItem);
