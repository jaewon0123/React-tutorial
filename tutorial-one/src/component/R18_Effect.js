...
function UseEffectEx(){
    return (
        ...
        <pre>
            ...
            리액트에서 컴포넌트를 렌더링하다 = 리액트에서 ㅇㅇ.js 코드실행 시작한다
        </pre>
        [useEffect] 사용 방법
        ...
        function : 00.js가 들어왔을 때 수행하고자 하는 작업
        deps : 배열 형태로, 배열 안에는 검사하고자 하는 특정 값, 반배열 작성
        deps에 특정값을 넣게 되면 컴포넌트가 실행될 때나 지정한 값이 업데이트 될 때
