import React, {createContext, uesContext, useContext} from "react";
/* 
Context 란 무엇인가
context를 사용하면 단계마다 일일이 props를 넘겨주지 않고도 
컴포넌트(객체)에 데이트를 제공할 수 있음
...
useContext
- 컨텍스트의 현재 값을 가져오는데 사용
    컨텍스트에서 어떤 값을 받아 현재 값으로 보여줌
...
const 부모 = () => {
    ...
    // TestContext에 value='부모가 전달한 값' 을 저장하고 Provider(제공할 것)
        <TestContext.Provider value='부모가 전달한 값'>
            <자식/>
