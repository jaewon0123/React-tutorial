...
/* 
React 초반에 function 이라는 함수로 묶어서 사용을 했지만
기능에 있어 부족한 부분이 발생
...
useState() 함수
 ...
 - 다시 새로고침하다 = 다시 랜더링하다 = ReRendering = 다시표현하다
 - Rendering = 표현
*/
/* 
...
// test = 가장 처음에 가지고 오는 변수값, 처음에 값이 없으면 값이 없는 상태로 있는 것
...
// const [초기값, 변경될값] = useState('처음에 들어갈 값이 무엇인지 작성');
    ...
    return (
        ...
        // 그렇다면 왜 !Doctype 부터 html과 head body와 같은 태그는 사용 안하는가?
        // public -> index.html 코드 안에 <div id="root">라는 공간 안에
        // 우리가 만드는 javascript와 html, css 와 같은 코드들이 모두 들어가는 것이기 때문
